...
function preload(){
  ...
  hero_img = loadImage("Hero2.jpg")
  //enemy1_img = loadImage("images/Enemy1.jpg");
  //enemy2_img = loadImage("images/Enemy2.jpg");
  enemy1_img = loadImage("Enemy1.jpg");
  enemy2_img = loadImage("Enemy2.jpg");
  laser_img = loadImage("LaserBeams.png");
  arrow_img = loadImage("arrow.png");
  
  arrow_sound = loadSound("laser sound.wav");
